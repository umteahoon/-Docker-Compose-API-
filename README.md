...
- **프로젝트 주제 선정**
  ...
  - 실제 구현 가능한 기술 스택과 팀원들의 역량을 고려하여 현실적인 목표 설정에 기여함.

- **팀 리더 역할 수행**
  - 팀장으로서 전체 작업 흐름을 체계적으로 정리하고, 각 파트에 맞게 역할을 효율적으로 분담함.
  - 주기적인 회의 주재와 문제 발생 시 신속한 의사소통으로 팀 내 협업을 원활하게 이끌었음.
  - 일정 관리와 우선순위 조정을 통해 프로젝트 데드라인을 준수할 수 있도록 팀을 이끔.
  - 기술적 난관 발생 시 대안을 모색하고 조언을 제공하여 프로젝트 완성도 향상에 기여함.

- **README.md 작성**
  - 프로젝트 구조, 실행 방법, 사용 기술 스택, 고도화 기능 등 전반적인 프로젝트 정보를 체계적으로 정리한 `README.md` 문서를 작성함.
  - 외부 개발자 및 팀원 모두가 쉽게 이해하고 활용할 수 있도록 명확하고 직관적인 설명을 담아 문서화의 완성도를 높임.

- **PPT 제작**
  - 발표 자료인 PPT를 직접 기획하고 제작하여, 프로젝트 개요부터 상세 구현 내용까지 청중에게 효과적으로 전달함.
  - 시각 자료를 활용해 핵심 개념과 성과를 명확하게 표현하고, 발표 연습을 통해 자신감 있는 발표를 진행함.

- **ChatGPT 활용**
  - 프로젝트의 전체적인 구조 설계 및 각 파일의 기본 코드 구현에 큰 도움을 받음.
  - 특히, 복잡한 코드에 대해 이해하기 쉬운 주석을 추가하고, 문서 및 파일 구성에 대해 체계적인 가이드라인을 얻어 효율적인 개발 환경을 마련함.
  - 반복적인 문서 작성과 코드 정리에 드는 시간을 크게 절감하여 개발에 더 집중할 수 있었음.

- **향후 기능 개선 방안 제안**
  - 출발 항공편 통합 조회, UI/UX 개선, 다크 모드 지원, 즐겨찾기 및 최근 조회 항공편 저장 기능 등 향후 고도화 방안 중 일부에 대해 직접 아이디어를 제시하고 팀 내 의견 교환에 활발히 참여함.
  - 사용자 편의성과 시스템 확장성을 고려한 다양한 개선책을 고민하며 프로젝트의 미래 발전 방향 설정에 기여함.
